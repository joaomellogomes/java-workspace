package br.com.aplicacaoweb.webapp.service;
...
import br.com.aplicacaoweb.webapp.model.UsuarioModel;
import br.com.aplicacaoweb.webapp.model.UsuarioSecurityModel;
import br.com.aplicacaoweb.webapp.repository.GrupoRepository;
import br.com.aplicacaoweb.webapp.repository.PermissaoRepository;
import br.com.aplicacaoweb.webapp.repository.UsuarioRepository;
...
public class UsuarioService implements UserDetailsService{
	...
	public UserDetails loadUserByUsername(String login) throws UsernameNotFoundException {
		...
		if(usuarioEntity == null) throw new BadCredentialsException("Usuário não encontrado no sistema!");

		if(!usuarioEntity.isAtivo()) throw new DisabledException("Usuário não está ativo no sistema!");
	...
	public List<UsuarioModel> consultarUsuarios(){
		...
		usuariosEntity.forEach(usuarioEntity ->{
			...
			usuariosModel.add(
					new UsuarioModel(usuarioEntity.getId(),
	...
	public void alterarUsuario(UsuarioModel usuarioModel){
		...
		UsuarioEntity usuarioEntity =  this.usuarioRepository.findOne(usuarioModel.getId());
